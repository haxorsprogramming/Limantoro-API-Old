...
class PurchaseReturnReq extends FormRequest
{
    /**
    ...
    public function rules()
    {
      ...
      //     $rules['number'] = 'required|regex:/^\S*$/|unique:App\Model\PurchaseReturn,number';
      // }
      if (request()->isMethod('put')) {
          $rules['number'] = 'required|regex:/^\S*$/|exists:App\Model\PurchaseReturn,number';
      }
      return $rules;
    }
