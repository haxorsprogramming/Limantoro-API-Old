...
class GoodsReturnReq extends FormRequest
{
    /**
    ...
    public function rules()
    {
      ...
      //     $rules['number'] = 'required|regex:/^\S*$/|unique:App\Model\GoodsReturn,number';
      // }
      if (request()->isMethod('put')) {
          $rules['number'] = 'required|regex:/^\S*$/|exists:App\Model\GoodsReturn,number';
      }
      return $rules;
    }
