     ...
     */
     public function rules()
     {
       ...
       if (request()->isMethod('post')) {
           $rules['code'] = 'required|min:3|regex:/^\S*$/|unique:\App\Model\Customer,code';
       }
       if (request()->isMethod('put')) {
           $rules['code'] = 'required|min:3|regex:/^\S*$/|exists:\App\Model\Customer,code';
           $rules['new_code'] = 'required|min:3|regex:/^\S*$/|unique:\App\Model\Customer,code,'.request()->code;
       }
             return $rules;
     }
